...
import static uk.ac.cam.ahk44.poker.Card.Value.ACE;
import static uk.ac.cam.ahk44.poker.Card.Value.EIGHT;
import static uk.ac.cam.ahk44.poker.Card.Value.FIVE;
import static uk.ac.cam.ahk44.poker.Card.Value.FOUR;
import static uk.ac.cam.ahk44.poker.Card.Value.JACK;
import static uk.ac.cam.ahk44.poker.Card.Value.KING;
import static uk.ac.cam.ahk44.poker.Card.Value.QUEEN;
import static uk.ac.cam.ahk44.poker.Card.Value.SIX;
import static uk.ac.cam.ahk44.poker.Card.Value.TEN;
